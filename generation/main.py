...
from model_one2one import IM_o2o
from model_res64 import IM_res64
from model_div import IM_div
...
parser.add_argument("--o2o", action="store_true", dest="o2o", default=False, help="True for o2o [False]")
parser.add_argument("--res64", action="store_true", dest="res64", default=False, help="True for res64 [False]")
parser.add_argument("--div", action="store_true", dest="div", default=False, help="True for deversified generation [False]")
...
if FLAGS.ae:
	...
	if FLAGS.train:
		...
		im_o2o.test_mesh_point(FLAGS)
elif FLAGS.res64:
	im_res64 = IM_res64(FLAGS)

	if FLAGS.train:
		im_res64.train(FLAGS)
	else:
		#im_svr.test_mesh(FLAGS)
		im_res64.test_mesh_point(FLAGS)
